...
function genreCreate(name, type, cb) {
  var genre = new Genre({ name: name, type:type });
...
function createGenreAuthors(cb) {
    async.parallel([
        ...
        function(callback) {
          genreCreate("Fantasy","non-fiction", callback);
        },
        function(callback) {
          genreCreate("Science Fiction","non-fiction", callback);
        },
        function(callback) {
          genreCreate("French Poetry", "fiction", callback);
        },
        ],
        // optional callback
        cb);
